          ...
          <div className="max-w-3xl mx-auto w-full">
            <div className="bg-surface-1 border border-border rounded-xl p-4">
              ...
              <div className="flex flex-wrap gap-2 mb-3">
                {["Post de Blog", "Artigo LinkedIn", "Newsletter", "Guia Completo", "Listicle"].map((type) => (
                  <button key={type} className="px-3 py-1.5 rounded-lg bg-surface-3 border border-border text-[10px] font-heading font-bold text-muted-foreground hover:border-primary/30 hover:text-foreground transition-colors cursor-pointer">
                    {type}
                  </button>
                ))}
              </div>
              <button className="inline-flex items-center gap-1.5 px-4 py-2 rounded-lg bg-primary text-primary-foreground font-heading font-extrabold text-[11px] cursor-pointer hover:bg-primary/90 transition-colors">
        ...
        {activeView === "textos" && (
          <div className="max-w-3xl mx-auto w-full">
            <div className="bg-surface-1 border border-border rounded-xl p-4">
              ...
              <div className="flex flex-wrap gap-2 mb-3">
                {["E-mail Marketing", "Anúncio", "Página de Venda", "Script de Vídeo", "Bio/Sobre", "Proposta Comercial"].map((type) => (
                  <button key={type} className="px-3 py-1.5 rounded-lg bg-surface-3 border border-border text-[10px] font-heading font-bold text-muted-foreground hover:border-[hsl(var(--blue))]/30 hover:text-foreground transition-colors cursor-pointer">
                    {type}
                  </button>
                ))}
              </div>
              <button className="inline-flex items-center gap-1.5 px-4 py-2 rounded-lg bg-[hsl(var(--blue))] text-primary-foreground font-heading font-extrabold text-[11px] cursor-pointer hover:opacity-90 transition-colors">
        ...
        {activeView === "apresentacoes" && (
          <div className="max-w-3xl mx-auto w-full">
            <div className="bg-surface-1 border border-border rounded-xl p-4">
              ...
              <div className="flex flex-wrap gap-2 mb-3">
                {["Comercial", "Pitch de Vendas", "Relatório Mensal", "Onboarding", "Case de Sucesso"].map((type) => (
                  <button key={type} className="px-3 py-1.5 rounded-lg bg-surface-3 border border-border text-[10px] font-heading font-bold text-muted-foreground hover:border-[hsl(var(--purple))]/30 hover:text-foreground transition-colors cursor-pointer">
                    {type}
                  </button>
                ))}
              </div>
              <button className="inline-flex items-center gap-1.5 px-4 py-2 rounded-lg bg-[hsl(var(--purple))] text-primary-foreground font-heading font-extrabold text-[11px] cursor-pointer hover:opacity-90 transition-colors">
        ...
        {activeView === "dossie" && (
          <div className="max-w-3xl mx-auto w-full space-y-4">
            <div className="bg-surface-1 border border-border rounded-xl p-4">
              ...
              <p className="text-[11px] text-muted-foreground mb-4 leading-relaxed">
                Gere dossiês completos para prospecção: dados de mercado, análise competitiva, SWOT, mapa de empatia e plano de ação — tudo com a identidade visual do cliente.
              </p>
              <div className="bg-surface-2 border border-border rounded-xl p-3 mb-3">
                <textarea
              ...
              <button className="inline-flex items-center gap-1.5 px-4 py-2 rounded-lg bg-[hsl(var(--amber))] text-amber-foreground font-heading font-extrabold text-[11px] cursor-pointer hover:opacity-90 transition-colors">
                <FileText className="w-3.5 h-3.5" /> Gerar Dossiê
              </button>
            </div>

            {/* Dossiê preview mockup */}
            <div className="bg-surface-1 border border-border rounded-xl p-4">
              <div className="text-[10px] text-dim font-heading font-bold uppercase tracking-wider mb-3">Preview do Dossiê</div>
              <div className="grid grid-cols-2 gap-2">
                {[
                  { label: "Tamanho do Mercado", value: "—" },
                  { label: "Crescimento", value: "—" },
                  { label: "Concorrentes", value: "—" },
                  { label: "Oportunidades", value: "—" },
                ].map((stat) => (
                  <div key={stat.label} className="p-3 rounded-lg bg-surface-2 border border-border">
                    <p className="text-[9px] text-dim font-heading font-bold uppercase tracking-wider">{stat.label}</p>
                    <p className="font-heading font-black text-lg text-muted-foreground">{stat.value}</p>
                  </div>
                ))}
              </div>
              <p className="text-[10px] text-dim text-center mt-3">Preencha os dados acima e gere o dossiê para ver o resultado completo</p>
            </div>
          </div>
        )}
      </div>
